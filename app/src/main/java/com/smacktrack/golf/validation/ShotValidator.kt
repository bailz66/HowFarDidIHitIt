...
/**
 * Input validation functions for shot data.
 *
 * Provides coordinate range checks, per-club plausible distance ranges,
 * weather data sanity checks, and timestamp validation. Used to guard
 * against corrupted or implausible data before persisting or displaying.
 */
