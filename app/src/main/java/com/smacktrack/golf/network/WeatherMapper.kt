...
/**
 * Utility functions for converting weather API data into display-friendly formats.
 *
 * Handles WMO weather codes (Open-Meteo API), wind direction degrees to compass
